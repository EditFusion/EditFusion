...
# Change model path to GraphCodeBERT
# bert_path = os.path.join(script_path, "../bert/graphcodebert-base")
# bert_path = os.path.join(script_path, "../bert/distilroberta-base")
...
# 加入编辑序列的特殊 token
edit_seq_tokens = {
    "eql": "<cc_eql_token>",    # 52000
    "add": "<cc_add_token>",    # 52001
    "del": "<cc_del_token>",
    "rep": "<cc_rep_token>",
    "padding": "<cc_padding_token>",  # 注意这个 padding token 和 tokenizer 的 padding token 不一样
}
