    ...
    def __init__(
        ...
        self.optimizer = optim.Adam(
            [
                ...
                {"params": lstm_params, "lr": training_param.lstm_lr},
        ...
        LSTM_dataset = self.model.CCEmbedding_class.get_dataset(self.dataset_path)
        self.accelerator.print(f"Dataset size: {len(LSTM_dataset)}")

        if debug:
            LSTM_dataset = Subset(LSTM_dataset, range(50))
        ...
        train_dataset, val_dataset, test_dataset = random_split(
            LSTM_dataset, [train_size, val_size, test_size]
        )
