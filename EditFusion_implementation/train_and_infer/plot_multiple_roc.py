...
#     explanation = """ROC Curve Interpretation:
# - Perfect prediction: Curve follows top-left corner (green dotted line)
# - Good prediction: Curve in light green area (above diagonal)
# - No predictive power: Diagonal blue dashed line (AUC = 0.5)
# - Poor prediction: Curve in light gray area (below diagonal)
# - Higher AUC values indicate better model performance"""
    
#     plt.figtext(0.15, 0.15, explanation, bbox=dict(facecolor='white', alpha=0.8), fontsize=12)
